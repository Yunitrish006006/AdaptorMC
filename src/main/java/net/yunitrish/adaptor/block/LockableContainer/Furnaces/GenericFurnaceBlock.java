package net.yunitrish.adaptor.block.LockableContainer.Furnaces;
...
public abstract class GenericFurnaceBlock extends BlockWithEntity {
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    public static final BooleanProperty LIT = Properties.LIT;

    protected GenericFurnaceBlock(AbstractBlock.Settings settings) {
        super(settings);
